...
) : ListAdapter<SupplierUi, SupplierListAdapter.SupplierViewHolder>(SupplierDiffCallback()) {

    inner class SupplierViewHolder(
        private val binding: ItemSupplierBinding
    ) : RecyclerView.ViewHolder(binding.root) {

        fun bind(supplier: SupplierUi, position: Int) {
            val b = binding
...
//            // --- Expansion handling ---
            b.layoutExpandable.visibility =
                if (supplier.isExpanded) View.VISIBLE else View.GONE
